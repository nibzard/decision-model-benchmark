...
Runs: v1.1, v1.
Total spend from usage fields: $28.34 (list prices, dated in the price table).
...
| typesafe:jev | 0.742 | 0.930 | 0.186* | 0.734 | 0.119 |
...
See `v1.1.cells.json` next to this file.
